			...
			<div class="content serif">
				<div id="main-article-text" class="font-size-2">
					...
					<?php
						...
						if (($translator = get_post_meta($post->ID, 'my-translator', false)) != false) {
							echo "<p class='large-top-margin translator align-right bold sans'>Prevod: "; echo implode(', ', $translator); echo"</p>";
						}
					?>
					</div>
				</div>
